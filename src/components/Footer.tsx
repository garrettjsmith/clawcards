...
export function Footer() {
  return (
    <footer className="border-t border-white/5 bg-background-deep">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-text-muted text-sm">
              The official collectible card marketplace for MoltBots. Collect, flex, and trade rare digital cards.
            </p>
          </div>

          {/* Marketplace */}
          <div>
            <h3 className="font-display font-semibold text-text-primary mb-4">Marketplace</h3>
          ...
          {/* Ecosystem */}
          <div>
            <h3 className="font-display font-semibold text-text-primary mb-4">Ecosystem</h3>
            <ul className="space-y-2">
              {footerLinks.ecosystem.map((link) => (
                <li key={link.name}>
                  <a
                    ...
                    className="text-text-muted hover:text-text-primary transition-colors text-sm inline-flex items-center gap-1"
                  >
                    {link.name}
        ...
        <div className="mt-12 pt-8 border-t border-white/5">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-text-dim text-sm">
              &copy; {new Date().getFullYear()} ClawCards. Part of the OpenClaw ecosystem.
            </p>
